...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 'gs://airbnb-chicago/listings-CSV';
...
STORED AS PARQUET LOCATION 'gs://airbnb-chicago/outputs/parquet_listings';
