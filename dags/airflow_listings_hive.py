...
HIVE_SCRIPT_URI = f"gs://airbnb-chicago/logic/listingsToParHive.hql"
...
with DAG(
    ...
    submit_hive_listings_job = DataprocSubmitHiveJobOperator(
        task_id="submit_hive_listings_job",
