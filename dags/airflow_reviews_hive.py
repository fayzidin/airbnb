...
HIVE_SCRIPT_URI = f"gs://airbnb-chicago/logic/reviewsToParHive.hql"
...
with DAG(
    ...
    submit_hive_reviews_job = DataprocSubmitHiveJobOperator(
        task_id="submit_hive_reviews_job",
