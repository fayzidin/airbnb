...
PYSPARK_SCRIPT_URI = f"gs://airbnb-chicago/logic/listingLogicToParquet.py"
...
with DAG(
    ...
    submit_pyspark_listings_job = DataprocSubmitJobOperator(
        task_id="submit_pyspark_listings_job",
