...
PYSPARK_SCRIPT_URI = f"gs://airbnb-chicago/logic/reviewsLogicToParquet.py"
...
with DAG(
    ...
    submit_pyspark_reviews_job = DataprocSubmitJobOperator(
        task_id="submit_pyspark_reviews_job",
